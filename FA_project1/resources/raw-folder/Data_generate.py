...
def gen_Product_CSV(rowNum):
    ...
    csvwriter = csv.writer(csvfile,delimiter=',',quotechar='"',quoting=csv.QUOTE_MINIMAL)
    csvwriter.writerow(["ProductID","ProductName","StandardCost","ListPrice","ProductCategory","ModifiedDate"])
    for i in range(1,rowNum+1):
        ...
        csvwriter.writerow([i,faker.text(max_nb_chars=20),StandardCost,ListPrice,Category,datetime.datetime(2010,1,1)])
    csvfile.close()
